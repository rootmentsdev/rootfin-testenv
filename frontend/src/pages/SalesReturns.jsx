  ...
  return (
    <div className="min-h-screen bg-[#f8faff]">
      ...
      <div className="ml-64 flex min-h-[calc(100vh-6rem)] flex-col items-center justify-center gap-5 px-10 text-center">
        <h1 className="text-3xl font-semibold text-[#0f172a]">Invoice Return</h1>
        <p className="max-w-2xl text-base text-[#6b7280]">
          Process your invoice returns in few simple steps and get your inventory automatically sorted out.
          Start creating invoice returns from invoices.
        </p>
        <Link
          to="/sales/invoices"
